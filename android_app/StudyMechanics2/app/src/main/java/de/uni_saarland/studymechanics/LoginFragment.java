...
public class LoginFragment extends Fragment {
    ...
    public void register(){
        if (mListener != null){
            mListener.onLoginFragmentRegister();
        }
    }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mListener.onLoginFragmentSignIn(email, password);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onLoginFragmentSignIn(String email, String password);
        void onLoginFragmentRegister();
    }
